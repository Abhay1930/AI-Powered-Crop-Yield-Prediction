        ...
        <div className="min-h-[80vh] flex items-center justify-center p-4">
            ...
            >
                ...
                <div className="flex flex-col items-center mb-8">
                    ...
                    <h2 className="text-3xl font-black text-gray-800 tracking-tight text-center">New Farm Setup</h2>
                    <p className="text-gray-500 text-sm mt-1">Join KrishiAI platform for smart agriculture</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    >
                        {isSubmitting ? <Loader2 className="w-5 h-5 animate-spin" /> : 'Create Farmer Account'}
                    </button>
                </form>
